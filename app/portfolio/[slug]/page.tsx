...
import { ArrowLeft, ArrowRight, Calendar, Clock, Users, CheckCircle, BarChart, Award } from "lucide-react"
    ...
    return (
      <div className="container px-4 py-12 md:px-6 md:py-24 lg:py-32">
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Case Study Not Found</h1>
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">{caseStudyData.title}</h1>
            ...
            <div className="flex items-center justify-center">
              <div className="overflow-hidden rounded-lg">
                <Image
                  src={caseStudyData.mainImage || "/placeholder.svg?height=600&width=800"}
                ...
                <CardContent className="grid gap-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{caseStudyData.duration}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{caseStudyData.client}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{caseStudyData.completionDate}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <div className="mt-6 flex items-center justify-center gap-4">
                <div className="h-12 w-12 overflow-hidden rounded-full">
                  <Image
                    src={caseStudyData.testimonial.image || "/placeholder.svg?height=100&width=100"}
                ...
                <div className="text-left">
                  <p className="font-medium">{caseStudyData.testimonial.author}</p>
                  <p className="text-sm text-muted-foreground">{caseStudyData.testimonial.position}</p>
                </div>
              </div>
            </div>
          </div>
...
function getCaseStudyData(slug: string) {
  ...
  const caseStudies = {
    ...
    "financial-dashboard": {
      ...
      technologies: ["React", "D3.js", "Node.js", "PostgreSQL", "Redis", "AWS", "Docker"],
      results: [
        { icon: "chart", value: "85%", label: "Reduction in reporting time" },
        { icon: "check", value: "45%", label: "Increase in data processing efficiency" },
        { icon: "award", value: "99.99%", label: "System reliability" },
      ],
      testimonial: {
        quote:
          "The financial dashboard developed by DevMatrix has transformed how we analyze and present data to our clients. The real-time visualizations and automated reporting have saved countless hours and improved our decision-making process.",
        author: "Jennifer Morgan",
        position: "CIO, Global Investments Ltd.",
        image: "/placeholder.svg?height=100&width=100&text=JM",
      },
      gallery: [
        { url: "/placeholder.svg?height=400&width=600&text=Dashboard+Overview", alt: "Dashboard main view" },
        { url: "/placeholder.svg?height=400&width=600&text=Portfolio+Analysis", alt: "Portfolio analysis screen" },
        { url: "/placeholder.svg?height=400&width=600&text=Real-time+Charts", alt: "Real-time data visualization" },
        { url: "/placeholder.svg?height=400&width=600&text=Report+Generation", alt: "Automated reporting interface" },
        { url: "/placeholder.svg?height=400&width=600&text=Data+Integration", alt: "Data source integration" },
        { url: "/placeholder.svg?height=400&width=600&text=Mobile+Dashboard", alt: "Mobile responsive dashboard" },
      ],
      relatedProjects: [
        {
          title: "Banking App",
    ...
    "logistics-management": {
      ...
      category: "Enterprise Software",
      description: "End-to-end logistics and supply chain management system for a global shipping company.",
      overview:
      ...
      mainImage: "/placeholder.svg?height=600&width=800&text=Logistics+Management",
      duration: "10 months",
      ...
      testimonial: {
        quote:
          "The logistics management system developed by DevMatrix has transformed our global shipping operations. We've seen a significant reduction in delivery times and operational costs while improving customer satisfaction through reliable tracking.",
        author: "Emily Rodriguez",
        position: "CTO, Global Shipping Solutions",
        image: "/placeholder.svg?height=100&width=100&text=ER",
      },
      gallery: [
        { url: "/placeholder.svg?height=400&width=600&text=Dashboard", alt: "Logistics dashboard" },
        { url: "/placeholder.svg?height=400&width=600&text=Route+Optimization", alt: "Route optimization interface" },
        { url: "/placeholder.svg?height=400&width=600&text=Tracking+Map", alt: "Real-time tracking map" },
        { url: "/placeholder.svg?height=400&width=600&text=Inventory+Management", alt: "Inventory management" },
        { url: "/placeholder.svg?height=400&width=600&text=Analytics", alt: "Supply chain analytics" },
        { url: "/placeholder.svg?height=400&width=600&text=Mobile+Tracking", alt: "Mobile tracking application" },
      ],
      relatedProjects: [
        {
          title: "Inventory Management System",
    ...
    "real-estate-platform": {
      ...
      mainImage: "/placeholder.svg?height=600&width=800&text=Real+Estate+Platform",
      duration: "9 months",
      client: "National Realty Group",
      completionDate: "May 2022",
      technologies: ["React", "Node.js", "MongoDB", "Three.js", "AWS", "Elasticsearch", "WebRTC"],
      results: [
        { icon: "chart", value: "215%", label: "Increase in online property views" },
        { icon: "check", value: "45%", label: "Reduction in time-to-sale" },
        { icon: "award", value: "4.9/5", label: "Agent satisfaction rating" },
      ],
      testimonial: {
        quote:
          "The real estate platform developed by DevMatrix has revolutionized how we showcase properties and connect with clients. The virtual tour feature became essential during the pandemic and continues to be a major competitive advantage.",
      ...
      gallery: [
        { url: "/placeholder.svg?height=400&width=600&text=Property+Listings", alt: "Property listing page" },
        { url: "/placeholder.svg?height=400&width=600&text=Virtual+Tour", alt: "360° virtual tour interface" },
        { url: "/placeholder.svg?height=400&width=600&text=Agent+Portal", alt: "Agent management dashboard" },
        { url: "/placeholder.svg?height=400&width=600&text=Property+Details", alt: "Detailed property information" },
        { url: "/placeholder.svg?height=400&width=600&text=Client+Communication", alt: "Client messaging system" },
        { url: "/placeholder.svg?height=400&width=600&text=Mobile+View", alt: "Mobile responsive design" },
      ],
      relatedProjects: [
        {
    ...
    "fitness-tracker": {
      ...
      mainImage: "/placeholder.svg?height=600&width=800&text=Fitness+Tracker+App",
      duration: "7 months",
      ...
      testimonial: {
        quote:
          "DevMatrix delivered a fitness app that exceeded our expectations in every way. The machine learning features for form correction and personalized workout recommendations have been particularly well-received by our users.",
        author: "Jason Kim",
        position: "CEO, FitLife Technologies",
        image: "/placeholder.svg?height=100&width=100&text=JK",
      },
      gallery: [
        { url: "/placeholder.svg?height=400&width=600&text=Dashboard", alt: "Fitness dashboard" },
        { url: "/placeholder.svg?height=400&width=600&text=Workout+Tracking", alt: "Workout tracking interface" },
        { url: "/placeholder.svg?height=400&width=600&text=Nutrition+Log", alt: "Nutrition logging" },
        { url: "/placeholder.svg?height=400&width=600&text=Form+Analysis", alt: "Workout form analysis" },
        { url: "/placeholder.svg?height=400&width=600&text=Social+Feed", alt: "Community social feed" },
        { url: "/placeholder.svg?height=400&width=600&text=Progress+Charts", alt: "Progress visualization" },
      ],
      relatedProjects: [
        {
          title: "Healthcare App",
    ...
    "cloud-migration": {
      ...
      technologies: ["AWS", "Docker", "Kubernetes", "Terraform", "Jenkins", "ELK Stack", "Python", "Go"],
      results: [
        { icon: "chart", value: "42%", label: "Reduction in infrastructure costs" },
        { icon: "check", value: "99.99%", label: "System availability" },
        { icon: "award", value: "85%", label: "Faster disaster recovery" },
      ],
      testimonial: {
        quote:
          "Their expertise in cloud migration saved us thousands in infrastructure costs while improving our system reliability and security. The DevMatrix team handled the complex migration with minimal disruption to our operations.",
        author: "Emily Rodriguez",
        position: "CTO, Financial Services Inc.",
        image: "/placeholder.svg?height=100&width=100&text=ER",
      },
      gallery: [
        { url: "/placeholder.svg?height=400&width=600&text=Cloud+Architecture", alt: "Cloud architecture diagram" },
        { url: "/placeholder.svg?height=400&width=600&text=Migration+Dashboard", alt: "Migration progress dashboard" },
        { url: "/placeholder.svg?height=400&width=600&text=Monitoring+System", alt: "Real-time monitoring" },
        { url: "/placeholder.svg?height=400&width=600&text=Security+Controls", alt: "Security implementation" },
        { url: "/placeholder.svg?height=400&width=600&text=Performance+Metrics", alt: "Performance comparison" },
        { url: "/placeholder.svg?height=400&width=600&text=Disaster+Recovery", alt: "Disaster recovery testing" },
      ],
      relatedProjects: [
        {
          title: "Financial Dashboard",
        ...
        },
        {
          ...
          category: "Cloud Solutions",
          description: "Implementation of serverless architecture for a high-traffic e-commerce platform.",
        ...
        },
        {
          ...
          category: "Cloud Solutions",
          description: "Transition from monolithic architecture to microservices for a SaaS platform.",
    ...
    "inventory-management": {
      title: "Inventory Management System",
      category: "Enterprise Software",
      description: "Comprehensive inventory system for a manufacturing company with barcode scanning and forecasting.",
      overview:
      ...
      mainImage: "/placeholder.svg?height=600&width=800&text=Inventory+Management",
      duration: "8 months",
      client: "ManufactureCo Industries",
      completionDate: "July 2022",
      technologies: [".NET Core", "SQL Server", "React", "TensorFlow", "Azure", "Power BI", "RFID", "Barcode Scanning"],
      results: [
      ...
      testimonial: {
        quote:
          "The inventory management system developed by DevMatrix has streamlined our operations and reduced errors by 75%. It's been a game-changer for our business, allowing us to optimize stock levels and improve cash flow.",
        author: "Robert Martinez",
        position: "Supply Chain Director, ManufactureCo Industries",
        image: "/placeholder.svg?height=100&width=100&text=RM",
      },
      gallery: [
        { url: "/placeholder.svg?height=400&width=600&text=Dashboard", alt: "Inventory dashboard" },
        { url: "/placeholder.svg?height=400&width=600&text=Barcode+Scanning", alt: "Barcode scanning interface" },
        { url: "/placeholder.svg?height=400&width=600&text=Stock+Levels", alt: "Real-time stock levels" },
        { url: "/placeholder.svg?height=400&width=600&text=Forecasting", alt: "Demand forecasting analytics" },
        { url: "/placeholder.svg?height=400&width=600&text=Warehouse+Map", alt: "Warehouse mapping" },
        { url: "/placeholder.svg?height=400&width=600&text=Mobile+Scanner", alt: "Mobile scanning application" },
      ],
      relatedProjects: [
        {
          title: "Logistics Management System",
    ...
    "educational-platform": {
      ...
      mainImage: "/placeholder.svg?height=600&width=800&text=Educational+Platform",
      duration: "9 months",
      client: "EduTech Learning",
      completionDate: "June 2023",
      technologies: ["Next.js", "Node.js", "PostgreSQL", "WebRTC", "AWS", "Redis", "Socket.io", "TensorFlow"],
      results: [
        { icon: "chart", value: "87%", label: "Course completion rate" },
        { icon: "check", value: "65%", label: "Increase in student engagement" },
        { icon: "award", value: "4.9/5", label: "Educator satisfaction" },
      ],
      testimonial: {
        quote:
          "Working with DevMatrix was a pleasure from start to finish. They understood our requirements perfectly and delivered a solution that exceeded our expectations. The platform has transformed how we deliver online education.",
        author: "Jennifer Lee",
        position: "Operations Manager, EduTech Learning",
        image: "/placeholder.svg?height=100&width=100&text=JL",
      },
      gallery: [
        { url: "/placeholder.svg?height=400&width=600&text=Course+Dashboard", alt: "Course dashboard" },
        { url: "/placeholder.svg?height=400&width=600&text=Video+Streaming", alt: "Video streaming interface" },
        { url: "/placeholder.svg?height=400&width=600&text=Interactive+Quizzes", alt: "Interactive assessments" },
        { url: "/placeholder.svg?height=400&width=600&text=Progress+Tracking", alt: "Student progress tracking" },
        { url: "/placeholder.svg?height=400&width=600&text=Analytics", alt: "Educator analytics dashboard" },
        { url: "/placeholder.svg?height=400&width=600&text=Mobile+Learning", alt: "Mobile learning experience" },
      ],
      relatedProjects: [
        {
          title: "Healthcare App",
